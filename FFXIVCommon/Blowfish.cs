...
namespace FFXIV
{
    public class Blowfish
    {
        ...
        private readonly UInt32[] p = new UInt32[16 + 2];
        ...
        public Boolean Encipher(Byte[] data, Int32 offset, Int32 length)
        {
        ...
        public Boolean Decipher(Byte[] data, Int32 offset, Int32 length)
        {
            if ((length - offset) % 8 != 0)
                throw new Exception("bad length");
            for (var i = offset; i < offset + length; i += 8)
